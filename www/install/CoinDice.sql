...
INSERT INTO `system` (`id`, `autoalias_increment`, `title`, `url`, `currency`, `currency_sign`, `description`, `giveaway`, `giveaway_amount`, `chat_enable`, `bot_enable`, `t_bets`, `t_wagered`, `t_wins`, `t_player_profit`, `house_edge`, `rolls_mintime`, `rolls_mintime_bB`, `giveaway_freq`, `min_withdrawal`, `bankroll_maxbet_ratio`) VALUES
(1,	1,	'default',	'default',	'default',	'default',	'default',	0,	0,	1,	1,	0,	0,	0,	0,	1,	500,	500,	60,	0.0002,	25);
